...
namespace InvokeDelegate
{
    class Program
    {
        ...
        public static void FunctionsAsAnArguments(Action obj, Action<string> obj2, Func<int, int> obj3, Func<string, string, bool> obj4,Func<int, double, double> obj5, Action<int> obj6)
        {
            //Invoke Delegate objects
            obj.Invoke();
            obj2.Invoke("string data");
            int intValue = obj3.Invoke(1);
            bool boolValue=obj4.Invoke("string", "data");
            double doubleValue=obj5.Invoke(5, 10.2);
            obj6.Invoke(5);
